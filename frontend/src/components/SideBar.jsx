...
function SideBar({ user }) {
    ...
    return (
        <section className="h-full font-sora">

            <aside
                className={`
                    h-full bg-surface-1/30 backdrop-blur-xl flex flex-col text-text-secondary
            ...
            >
                ...
                <ul className='flex flex-col justify-center text-text-secondary flex-1 gap-3 w-full'>
                    <li className='p-2 px-3 hover:bg-surface-2 hover:text-text-primary rounded-lg duration-300 ease-in-out'>
                    ...
                    <li className='p-2 px-3 hover:bg-surface-2 rounded-lg duration-300 ease-in-out'>
                ...
                <div className='w-full'>
                    {
                        expanded ?
                            <div className='flex items-center gap-2 border-t border-stroke pt-2 pb-2 px-2 w-full hover:bg-surface-2 rounded-lg duration-300 ease-in-out'>
                                <img
                            ...
                            <div className='flex items-center gap-2 border-t border-stroke pt-2 pb-2 px-2 w-full hover:bg-surface-2 rounded-b-xl duration-300 ease-in-out'>
                                <img
                                    src={user?.profile_pic_path || Default}
                                    alt="Profile"
                                    className='w-10 h-10 rounded-full object-cover'
